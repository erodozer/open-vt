...
func _process(_delta: float) -> void:
	var mouse = GlobalInput.get_mouse_position()
	...
	update({
		...
		"MousePressedLeft": GlobalInput.is_mouse_button_pressed(MOUSE_BUTTON_LEFT),
		"MousePressedRight": GlobalInput.is_mouse_button_pressed(MOUSE_BUTTON_RIGHT),
		"MousePressedMiddle": GlobalInput.is_mouse_button_pressed(MOUSE_BUTTON_MIDDLE),
		"PenPressure": GlobalInput.get_pen_pressure(),
	})
